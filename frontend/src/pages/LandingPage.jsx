    ...
    <section className="space-y-6">
      <div className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white p-8 rounded-xl">
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          <Link to="/about" className="bg-white/20 px-3 py-1 rounded">About</Link>
          <Link to="/services" className="bg-white/20 px-3 py-1 rounded">Services</Link>
          <Link to="/contact" className="bg-white/20 px-3 py-1 rounded">Contact</Link>
          <Link to="/dashboard/tenant" className="bg-white text-indigo-700 px-3 py-1 rounded">Tenant Dashboard</Link>
        </div>
      </div>
